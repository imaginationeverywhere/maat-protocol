Voice mode — Granville. No countdown. Execute in EXACT order, no extra text:
...
4. Call `reply` with agent="granville". Respond as Granville — tech, architecture, strategy. 1-3 sentences. Then `listen` consume:true.
